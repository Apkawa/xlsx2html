...
currency_formats = [
    ([1000, "#,##0.00\\ [$\u0440.-419];\\-#,##0.00\\ [$\u0440.-419]", "ru"], "1\xa0000,00 р."),
    ([-1000, "#,##0.00\\ [$\u0440.-419];\\-#,##0.00\\ [$\u0440.-419]", "ru"], "-1\xa0000,00 р."),
    ([-1000, "#,##0.00\\ [$\u0440.-419];\\-#,##0.00\\ [$\u0440.-419]", "en"], "-1,000.00 р."),
    (
    ...
    ([1000, "_(\\$* #,##0.00_);_(\\$* \\(#,##0.00\\);_(\\$* \\-??_);_(@_)", "en"], " $ 1,000.00 "),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([(dt + datetime.timedelta(hours=14)).time(), "HH:MM:SS AM/PM", "en"], "08:09:05 PM"),
